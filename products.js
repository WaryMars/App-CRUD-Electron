...
ipcRenderer.on('product-list', (event, rows) => {
    for (var i = 0; i < rows.length; i++) {
        ...
        " <button type='button' class='btn btn-primary' onclick='SuppLigne(this)' class='btn-del' style='border: none; background-color: white;'> <img src='data:image/png;base64,'/> </button> " + "</td></tr>";
